...
def readEfficiencyHistogram():
    ...
    _str =  "bonsai_root_files%s/%s/histograms_U238_%06.3fPPM_Th232_%06.3fPPM_K_%06.3fPPMT.root"%(additionalMacStr,_cover,float(arguments["--U238_PPM"]),float(arguments["--Th232_PPM"]),float(arguments["--K_PPM"]))
